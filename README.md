...
30 skills, 5 agents, 4 rules — plug into Claude Code, skip the prompt engineering.
...
> [!NOTE]
> Everything in this repo is grounded in [official Claude Code documentation](https://code.claude.com/docs/en/memory) and published research.
